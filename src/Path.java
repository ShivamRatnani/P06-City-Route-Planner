...
public class Path {
    ...
    public void addTail(Intersection toAdd) throws IllegalArgumentException {
        ...
        if (toAdd.equals(emptyPath) || toAdd.equals(east) || toAdd.equals(north))
    ...
    public void addHead(Intersection toAdd) throws IllegalArgumentException {
        ...
        if (toAdd.equals(emptyPath) || toAdd.equals(west) || toAdd.equals(south))
        ...
        if (intersections.size() == 0)
            ...
            for (int i = 0; i < intersections.size(); i++) {
                if (i != intersections.size() - 1)
                    nonEmptyPath += intersections.get(i).toString() + "->";
                else
                    nonEmptyPath += intersections.get(i).toString();
            }
        }
